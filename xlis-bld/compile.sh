...
mpif90  -c -free -check -traceback -I.  \
  ...
  my_code/pftvarcon.F90 \
  my_code/BiogeophysRestMod.F90 \
  my_code/surfrdMod.F90 \
  my_code/clm_time_manager.F90 \
...
mpif90  -free -check -traceback -o xlis_main xlis_main.o clm_driver.o clm_initializeMod.o pftvarcon.o surfrdMod.o BiogeophysRestMod.o ncdio_pio.o \
  clm_time_manager.o \
