...
!YDT 
  if (masterproc) write(iulog,*)sub,': after init_calendar()  '
...
!YDT 
  if (masterproc) write(iulog,*)sub,': before timemgr_print()  '

  if (masterproc) call timemgr_print()

!YDT 
  if (masterproc) write(iulog,*)sub,': after timemgr_print()  '
